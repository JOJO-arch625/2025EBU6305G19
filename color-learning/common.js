(function () {
    ...
    var pageTitleTexts = { en: {}, zh: {} };
    var pageSubtitleTexts = { en: {}, zh: {} };
    ...
    function init() {
        logoClickHandler();
        navToggleHandler();
        var initialZh = window.SiteSettings ? window.SiteSettings.isZh() : (root.getAttribute('lang') === 'zh');
        applyCommonLanguage(initialZh);
        document.addEventListener('site-settings:change', function (event) {
            applyCommonLanguage(event.detail.lang === 'zh');
        });
    }
